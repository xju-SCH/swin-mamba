...
# Swin Mamba parameters
_C.MODEL.SWIN_MAMBA = CN()
_C.MODEL.SWIN_MAMBA.PATCH_SIZE = 4
_C.MODEL.SWIN_MAMBA.IN_CHANS = 3
_C.MODEL.SWIN_MAMBA.EMBED_DIM = 96
_C.MODEL.SWIN_MAMBA.DEPTHS = [2, 2, 6, 2]
_C.MODEL.SWIN_MAMBA.NUM_HEADS = [3, 6, 12, 24]
_C.MODEL.SWIN_MAMBA.WINDOW_SIZE = 7
_C.MODEL.SWIN_MAMBA.MLP_RATIO = 4.0
_C.MODEL.SWIN_MAMBA.QKV_BIAS = True
_C.MODEL.SWIN_MAMBA.QK_SCALE = None
_C.MODEL.SWIN_MAMBA.APE = False
_C.MODEL.SWIN_MAMBA.PATCH_NORM = True
_C.MODEL.SWIN_MAMBA.FUSED_WINDOW_PROCESS = False
_C.MODEL.SWIN_MAMBA.D_STATE = 16
_C.MODEL.SWIN_MAMBA.RMS_NORM = False
